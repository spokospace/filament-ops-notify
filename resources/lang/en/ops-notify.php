...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'This is how a message looks in the chat. Change what you want on it; the rest stays as it is.',
        'template_default_look' => 'All messages',
        'template_exceptions' => 'Some events, differently',
        'template_exceptions_description' => 'Messages of these events look different from the rest. Checked from the top, the first match wins.',
        'template_which' => 'Which messages',
        'template_by_rule' => 'By where they go',
        'template_by_event' => 'By event',
        'template_title' => 'Title',
        'template_text' => 'Text',
        'template_fields' => 'Fields',
        'template_mode_keep' => 'Keep as it is',
        'template_mode_change' => 'Change it',
        'template_mode_leave_out' => 'Leave it out',
        'template_mode_all' => 'Show all',
        'template_mode_choose' => 'Choose which',
        'template_no_fields' => 'This message has no fields.',
        'template_hashtag_shown' => 'End with :hashtag',
        'template_service_shown' => 'Start with :service',
        ...
        'template_body_help' => 'The same placeholders work here.',
        'template_default_body' => ":body\n\nEvent :event on :service.",
        'template_default' => 'Back to the default look',
        'sample_title' => 'New inquiry',
        'sample_body' => 'Anna asks about a product.',
        'sample_name' => 'Name',
        'sample_email' => 'Email',
        'add_template' => 'Add an exception',
        'preview' => 'How it will look',
        'preview_from' => 'The latest :event message, :date.',
        'preview_no_pattern' => 'Choose the messages first.',
        'preview_sample' => 'An example message: nothing matching :pattern was logged since :date.',
        'preview_sample_any' => 'An example message: nothing was logged since :date.',
        'preview_shadowed' => 'The exception :pattern matches :event first, so that one is used.',
