...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'So sieht eine Nachricht im Chat aus. Ändern Sie daran, was Sie möchten; der Rest bleibt, wie er ist.',
        'template_default_look' => 'Alle Nachrichten',
        'template_exceptions' => 'Ausgewählte Ereignisse anders',
        'template_exceptions_description' => 'Nachrichten dieser Ereignisse sehen anders aus als der Rest. Von oben geprüft, der erste Treffer gewinnt.',
        'template_which' => 'Welche Nachrichten',
        'template_by_rule' => 'Nach Ziel',
        'template_by_event' => 'Nach Ereignis',
        'template_title' => 'Titel',
        'template_text' => 'Text',
        'template_fields' => 'Felder',
        'template_mode_keep' => 'So lassen',
        'template_mode_change' => 'Ändern',
        'template_mode_leave_out' => 'Weglassen',
        'template_mode_all' => 'Alle anzeigen',
        'template_mode_choose' => 'Auswählen',
        'template_no_fields' => 'Diese Nachricht hat keine Felder.',
        'template_hashtag_shown' => 'Mit :hashtag enden',
        'template_service_shown' => 'Mit :service beginnen',
        'template_placeholders' => 'Text bleibt wie geschrieben; ein Platzhalter übernimmt den Wert aus der Nachricht. Ein fehlendes Feld bleibt leer.',
        'template_default_title' => ':title (:level)',
        'template_body_help' => 'Hier gelten dieselben Platzhalter.',
        'template_default_body' => ":body\n\nEreignis :event von :service.",
        'template_default' => 'Zurück zum Standardaussehen',
        'sample_title' => 'Neue Anfrage',
        'sample_body' => 'Anna fragt nach einem Produkt.',
        'sample_name' => 'Name',
        'sample_email' => 'E-Mail',
        'add_template' => 'Ausnahme hinzufügen',
        'preview' => 'So wird es aussehen',
        'preview_from' => 'Die neueste Nachricht zu :event, :date.',
        'preview_no_pattern' => 'Wählen Sie zuerst die Nachrichten.',
        'preview_sample' => 'Eine Beispielnachricht: seit :date wurde nichts protokolliert, was zu :pattern passt.',
        'preview_sample_any' => 'Eine Beispielnachricht: seit :date wurde nichts protokolliert.',
        'preview_shadowed' => 'Die Ausnahme :pattern passt zuerst auf :event, also wird sie verwendet.',

        'forwarding' => 'Filament-Benachrichtigungen',
        'forwarding_description' => 'Glocken-Benachrichtigungen, die an den Ops-Kanal weitergeleitet werden. Regeln prüfen den Titel, und * passt auch hier auf alles, z. B. Neue Anfrage*. Die erste passende gewinnt.',
