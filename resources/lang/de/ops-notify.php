...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'Lege fest, wie die Nachrichten eines Ereignisses aussehen: Titel, Text, angezeigte Felder und Hashtag. Die Vorlagen werden von oben geprüft, das erste passende Muster gewinnt. Ereignisse ohne Treffer behalten das Standardlayout. Vorlagentext ist reiner Text.',
        ...
        'template_body' => 'Text',
        'template_body_help' => 'Leer lassen, um den Nachrichtentext zu behalten. Dieselben Platzhalter funktionieren auch hier.',
        ...
        'template_fields_help' => 'Nur diese Felder, in dieser Reihenfolge. Leer lassen, um alle anzuzeigen.',
        'template_show_body' => 'Text',
        'template_show_fields' => 'Felder',
        'template_hashtag' => 'Hashtag',
        'template_service' => 'Dienstname',
        'add_template' => 'Vorlage hinzufügen',
        'preview' => 'Vorschau',
        'preview_from' => 'Die neueste Nachricht zu :event, :date.',
        'preview_no_pattern' => 'Gib zuerst ein Muster ein.',
        'preview_sample' => 'Eine Beispielnachricht: seit :date wurde nichts protokolliert, was zu :pattern passt.',
        'preview_shadowed' => 'Die Vorlage :pattern weiter oben passt zuerst auf :event und wird daher verwendet.',
