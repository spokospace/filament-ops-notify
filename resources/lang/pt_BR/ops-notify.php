...
return [
    ...
    'settings' => [
        ...
        'pattern' => 'Padrão',
        'seen_recent' => 'Eventos do último :count dia, com o número de mensagens.|Eventos dos últimos :count dias, com o número de mensagens.',
        ...
        'templates_description' => 'É assim que uma mensagem aparece no chat. Mude nela o que quiser; o resto fica como está.',
        'template_default_look' => 'Todas as mensagens',
        'template_exceptions' => 'Alguns eventos, de outro jeito',
        'template_exceptions_description' => 'As mensagens desses eventos ficam diferentes das demais. Verificadas de cima para baixo, a primeira correspondência vence.',
        'template_which' => 'Quais mensagens',
        'template_by_rule' => 'Pelo destino',
        'template_by_event' => 'Por evento',
        'template_title' => 'Título',
        'template_text' => 'Texto',
        'template_fields' => 'Campos',
        'template_mode_keep' => 'Deixar como está',
        'template_mode_change' => 'Mudar',
        'template_mode_leave_out' => 'Deixar de fora',
        'template_mode_all' => 'Mostrar todos',
        'template_mode_choose' => 'Escolher quais',
        'template_no_fields' => 'Esta mensagem não tem campos.',
        'template_hashtag_shown' => 'Terminar com :hashtag',
        'template_service_shown' => 'Começar com :service',
        ...
        'template_body_help' => 'Os mesmos marcadores funcionam aqui.',
        'template_default_body' => ":body\n\nEvento :event de :service.",
        'template_default' => 'Voltar à aparência padrão',
        'sample_title' => 'Nova consulta',
        'sample_body' => 'Anna pergunta sobre um produto.',
        'sample_name' => 'Nome',
        'sample_email' => 'E-mail',
        'add_template' => 'Adicionar uma exceção',
        'preview' => 'É assim que vai ficar',
        'preview_from' => 'A mensagem mais recente de :event, :date.',
        'preview_no_pattern' => 'Escolha as mensagens primeiro.',
        'preview_sample' => 'Uma mensagem de exemplo: nada correspondente a :pattern foi registrado desde :date.',
        'preview_sample_any' => 'Uma mensagem de exemplo: nada foi registrado desde :date.',
        'preview_shadowed' => 'A exceção :pattern corresponde primeiro a :event, então ela é usada.',
