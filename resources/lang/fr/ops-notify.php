...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'Voici à quoi ressemble un message dans le chat. Changez ce que vous voulez dessus ; le reste reste tel quel.',
        'template_default_look' => 'Tous les messages',
        'template_exceptions' => 'Certains événements, autrement',
        'template_exceptions_description' => 'Les messages de ces événements ont un autre aspect. Vérifiés depuis le haut, la première correspondance l\'emporte.',
        'template_which' => 'Quels messages',
        'template_by_rule' => 'Selon leur destination',
        'template_by_event' => 'Par événement',
        'template_title' => 'Titre',
        'template_text' => 'Texte',
        'template_fields' => 'Champs',
        'template_mode_keep' => 'Laisser tel quel',
        'template_mode_change' => 'Le changer',
        'template_mode_leave_out' => 'L\'omettre',
        'template_mode_all' => 'Tout afficher',
        'template_mode_choose' => 'Choisir lesquels',
        'template_no_fields' => 'Ce message n\'a aucun champ.',
        'template_hashtag_shown' => 'Terminer par :hashtag',
        'template_service_shown' => 'Commencer par :service',
        'template_placeholders' => 'Le texte reste tel quel ; un espace réservé prend la valeur du message. Un champ manquant reste vide.',
        'template_default_title' => ':title (:level)',
        'template_body_help' => 'Les mêmes espaces réservés fonctionnent ici.',
        'template_default_body' => ":body\n\nÉvénement :event de :service.",
        'template_default' => 'Revenir à l\'aspect par défaut',
        'sample_title' => 'Nouvelle demande',
        'sample_body' => 'Anna se renseigne sur un produit.',
        'sample_name' => 'Nom',
        'sample_email' => 'E-mail',
        'add_template' => 'Ajouter une exception',
        'preview' => 'Voici à quoi cela ressemblera',
        'preview_from' => 'Le dernier message de :event, :date.',
        'preview_no_pattern' => 'Choisissez d\'abord les messages.',
        'preview_sample' => 'Un message d\'exemple : rien ne correspondant à :pattern n\'a été enregistré depuis le :date.',
        'preview_sample_any' => 'Un message d\'exemple : rien n\'a été enregistré depuis le :date.',
        'preview_shadowed' => 'L\'exception :pattern correspond d\'abord à :event, c\'est donc elle qui est utilisée.',
