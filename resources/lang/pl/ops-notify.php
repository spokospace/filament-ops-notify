...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'Tak wygląda wiadomość na czacie. Zmień na niej to, co chcesz; reszta zostaje jak jest.',
        'template_default_look' => 'Wszystkie wiadomości',
        'template_exceptions' => 'Wybrane zdarzenia inaczej',
        'template_exceptions_description' => 'Wiadomości tych zdarzeń wyglądają inaczej niż pozostałe. Sprawdzane od góry, wygrywa pierwsze dopasowanie.',
        'template_which' => 'Które wiadomości',
        'template_by_rule' => 'Według miejsca, do którego trafiają',
        'template_by_event' => 'Według zdarzenia',
        'template_title' => 'Tytuł',
        'template_text' => 'Treść',
        'template_fields' => 'Pola',
        'template_mode_keep' => 'Zostaw jak jest',
        'template_mode_change' => 'Zmień',
        'template_mode_leave_out' => 'Pomiń',
        'template_mode_all' => 'Pokaż wszystkie',
        'template_mode_choose' => 'Wybierz które',
        'template_no_fields' => 'Ta wiadomość nie ma pól.',
        'template_hashtag_shown' => 'Zakończ :hashtag',
        'template_service_shown' => 'Zacznij od :service',
        ...
        'template_body_help' => 'Działają tu te same zmienne.',
        'template_default_body' => ":body\n\nZdarzenie :event z :service.",
        'template_default' => 'Wróć do domyślnego wyglądu',
        'sample_title' => 'Nowe zapytanie',
        'sample_body' => 'Anna pyta o produkt.',
        'sample_name' => 'Imię',
        'sample_email' => 'E-mail',
        'add_template' => 'Dodaj wyjątek',
        'preview' => 'Tak to będzie wyglądać',
        'preview_from' => 'Najnowsza wiadomość :event, :date.',
        'preview_no_pattern' => 'Najpierw wybierz wiadomości.',
        'preview_sample' => 'Przykładowa wiadomość: od :date nie zalogowano nic pasującego do :pattern.',
        'preview_sample_any' => 'Przykładowa wiadomość: od :date nie zalogowano żadnej wiadomości.',
        'preview_shadowed' => 'Wyjątek :pattern pierwszy pasuje do :event, więc to on jest używany.',
