...
return [
    ...
    'settings' => [
        ...
        'templates_description' => 'Zo ziet een bericht eruit in de chat. Verander erop wat je wilt; de rest blijft zoals het is.',
        'template_default_look' => 'Alle berichten',
        'template_exceptions' => 'Sommige gebeurtenissen anders',
        'template_exceptions_description' => 'Berichten van deze gebeurtenissen zien er anders uit dan de rest. Van boven gecontroleerd, de eerste match wint.',
        'template_which' => 'Welke berichten',
        'template_by_rule' => 'Op bestemming',
        'template_by_event' => 'Per gebeurtenis',
        'template_title' => 'Titel',
        'template_text' => 'Tekst',
        'template_fields' => 'Velden',
        'template_mode_keep' => 'Laten zoals het is',
        'template_mode_change' => 'Veranderen',
        'template_mode_leave_out' => 'Weglaten',
        'template_mode_all' => 'Alles tonen',
        'template_mode_choose' => 'Kiezen welke',
        'template_no_fields' => 'Dit bericht heeft geen velden.',
        'template_hashtag_shown' => 'Eindigen met :hashtag',
        'template_service_shown' => 'Beginnen met :service',
        ...
        'template_body_help' => 'Dezelfde plaatshouders werken hier.',
        'template_default_body' => ":body\n\nGebeurtenis :event van :service.",
        'template_default' => 'Terug naar het standaarduiterlijk',
        'sample_title' => 'Nieuwe aanvraag',
        'sample_body' => 'Anna vraagt naar een product.',
        'sample_name' => 'Naam',
        'sample_email' => 'E-mail',
        'add_template' => 'Uitzondering toevoegen',
        'preview' => 'Zo gaat het eruitzien',
        'preview_from' => 'Het nieuwste bericht van :event, :date.',
        'preview_no_pattern' => 'Kies eerst de berichten.',
        'preview_sample' => 'Een voorbeeldbericht: sinds :date is er niets gelogd dat overeenkomt met :pattern.',
        'preview_sample_any' => 'Een voorbeeldbericht: sinds :date is er niets gelogd.',
        'preview_shadowed' => 'De uitzondering :pattern komt als eerste overeen met :event, dus die wordt gebruikt.',
